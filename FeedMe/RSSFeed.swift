...
class RSSFeed: NSObject, NSCoding {
    ...
    required init?(coder aDecoder: NSCoder)
    {
        ...
        customTitle = aDecoder.decodeObjectForKey("customTitle") as? String
        rawLink = aDecoder.decodeObjectForKey("rawLink") as? NSURL
    ...
    func encodeWithCoder(aCoder: NSCoder)
    {
        ...
        {
            aCoder.encodeObject(customTitle, forKey: "customTitle")
        }
        if let rawLink = self.rawLink
        {
            aCoder.encodeObject(rawLink, forKey: "rawLink")
        }
